...
export const getHOD = (data)=>POST("/form/getHod",data)

export const getDepartment = ()=>POST("/form/getAllDepartments")
export const getSSDPs = ()=>POST("/form/getAllSsdp")
export const download = (data)=>POST("/form/download",data)
